...
%>
   	...
   	<div>
		...
		<div class="col-md-12" style="padding: 20px 10px 10px 20px;" align="center">
			<div  class="col-md-12">
				<h2 style="font-weight: 700; font-family: '맑은고딕';"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> 당신과 함께할 강의</h2>
				<p style="font-family: '맑은고딕';">당신과 함께할 강의를 찾으세요. 'StudyUp'에서 당신을 도와줄 선생님이 기다리고 있습니다.</p>
			</div>
		</div>						
			...
			<div class= "searchStudy col-xs-12 col-md-12">
				<div class="col-xs-4">
					<select class="form-control" id="selectCondition">
						...
						<option value="studyName">강의명</option>
						<option value="userId">선생님</option>
			...
			<div class="study-content col-xs-12 col-sm-6 col-md-4" data-studyNum="${dto.studyNum}" data-categoryName="${dto.categoryName}">
				...
				<div class="thumbnail" style="text-align: center; cursor:pointer;">
					<div style="padding-top: 5px">
						<img class="img-rounded" src="<%=cp%>/uploads/lecture/${dto.studyImg}" alt="...">
					</div>
					<div onclick="location.href='#';">
						<div style="">
							<div class="study-title">${dto.studyName}</div>
							<div class="studyIntro">${dto.studyIntro}</div>
							<div>선생님: <a href="<%=cp%>/teacher/main?tnum=${dto.tnum}&left=0">${dto.nickname}</a></div>
