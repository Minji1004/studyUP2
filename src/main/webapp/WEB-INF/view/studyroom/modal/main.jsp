	...
	$(function(){
		...
		<div class="srModal-body">
			<div class="srModalDetail">
				...
				<form name="srModalMain" method="post">	
					<div class="col-xs-12 col-sm-6 col-md-4">
						<!-- 시간 선택 정보 -->
						...
						<div class="srSecondOneModal">
							...
							<div class="scrollSecondOneModal">
								<input type="text" class="srModalDatePicker" id="srDatepicker" name="useDate"> 
							</div>
						...
						<div class="srSecondTwoModal">
									...
									<c:forEach var="modto" items="${sr.studyRoomList}">
										<tr class="srTableLine" style="border">
											...
											<td class="secondTableContent">
												${modto.unitPrice}
												<input type="hidden" name="unitPrices" value="${modto.unitPrice}">
											</td>
											<td class="secondTablePeople">
												${modto.minUser}/${modto.maxUser}명
												<input type="hidden" id="modalRoomName" name="modalRoomName" value="${modto.roomName}">
												<input type="hidden" id="modalRoomNum" name="modalRoomNum" value="${modto.roomNum}">
							...
							<div class="srModalNext">
								<input type="text" class="srModalPeople" value="0" name="peopleNum">
					...
					<div class="col-xs-12 col-sm-12 col-md-4">
						<div class="srThirdModal">
							...
							<!-- 하단 버튼 -->
							<div class="srModalNext">
								<button type="button" class="btn-srModalNext" data-dismiss="modal" id="addBag">장바구니</button>
