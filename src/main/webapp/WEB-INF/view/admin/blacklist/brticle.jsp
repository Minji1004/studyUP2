...
<div class="smodal-body modal-body row">
 	<div class="col-xs-4 col-sm-7">
 		<div class="dialog-content-title"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>블랙리스트 번호:${bdto.blackNum}</div>
 		...
 		<div class="dialog-content"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span>해제일:${bdto.blackEnd } </div>
 	</div>
</div>
<div class="modal-footer">
	<input type="hidden" name="reportedUserNum" value="${bdto.blackNum }">
	<button type="button" class="btn btn-primary" id="blackClear" data-target ="blackCancle">블랙리스트 해제</button>
