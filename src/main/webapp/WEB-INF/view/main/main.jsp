        ...
        <div class="container-fluid">
            <div class="row no-gutter">
                <div class="col-lg-3 col-md-6 col-sm-6 work">
                    <a href="<%=cp%>/resource/images/work-1.jpg" class="work-box">
                        <img src="<%=cp%>/resource/images/work-1.jpg" alt="">
                        <div class="overlay">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 work">
                    <a href="<%=cp%>/resource/images/work-2.jpg" class="work-box">
                        <img src="<%=cp%>/resource/images/work-2.jpg" alt="">
                        <div class="overlay">
                            <div class="overlay-caption">
                                <h5>Project Name</h5>
                                <p>Website Design</p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 work">
                    <a href="<%=cp%>/resource/images/work-3.jpg" class="work-box">
                        <img src="<%=cp%>/resource/images/work-3.jpg" alt="">
                        <div class="overlay">
                            <div class="overlay-caption">
                                <h5>Project Name</h5>
                                <p>Website Design</p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 work">
                    <a href="<%=cp%>/resource/images/work-4.jpg" class="work-box">
                        <img src="<%=cp%>/resource/images/work-4.jpg" alt="">
                        <div class="overlay">
                            <div class="overlay-caption">
                                <h5>Project Name</h5>
                                <p>Website Design</p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 work">
                    <a href="<%=cp%>/resource/images/work-5.jpg" class="work-box">
                        <img src="<%=cp%>/resource/images/work-5.jpg" alt="">
                        <div class="overlay">
                            <div class="overlay-caption">
                                <h5>Project Name</h5>
                                <p>Website Design</p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 work">
                    <a href="<%=cp%>/resource/images/work-6.jpg" class="work-box">
                        <img src="<%=cp%>/resource/images/work-6.jpg" alt="">
                        <div class="overlay">
                            <div class="overlay-caption">
                                <h5>Project Name</h5>
                                <p>Website Design</p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 work">
                    <a href="<%=cp%>/resource/images/work-7.jpg" class="work-box">
                        <img src="<%=cp%>/resource/images/work-7.jpg" alt="">
                        <div class="overlay">
                            <div class="overlay-caption">
                                <h5>Project Name</h5>
                                <p>Website Design</p>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 work">
                    <a href="<%=cp%>/resource/images/work-8.jpg" class="work-box">
                        <img src="<%=cp%>/resource/images/work-8.jpg" alt="">
                        <div class="overlay">
                            <div class="overlay-caption">
                                <h5>Project Name</h5>
                                <p>Website Design</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="person">
                        <img src="<%=cp%>/resource/images/team-1.jpg" alt="" class="img-responsive">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="person">
                        <img src="<%=cp%>/resource/images/team-2.jpg" alt="" class="img-responsive">
                        <div class="person-content">
                            <h4>Timothy Reed</h4>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="person">
                        <img src="<%=cp%>/resource/images/team-3.jpg" alt="" class="img-responsive">
                        <div class="person-content">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="person">
                        <img src="<%=cp%>/resource/images/team-4.jpg" alt="" class="img-responsive">
                        <div class="person-content">
