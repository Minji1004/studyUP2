...
public class WorryBoard {
	...
	private int worrynoticeWhether;
	private int views;
	...
	public int getWorrynoticeWhether() {
		return worrynoticeWhether;
	}

	public void setWorrynoticeWhether(int worrynoticeWhether) {
		this.worrynoticeWhether = worrynoticeWhether;
	}
